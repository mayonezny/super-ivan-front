...
const ProfilePreferencesNavbar = ({ disabled, className }: ProfilePreferencesNavbarProps) => {
  ...
  return (
    <div className='relative'>
      ...
      <div className={clsx('-z-[1] absolute top-[12%] right-[-200%] text-nowrap bg-white pl-8 p-2 shadow-[0px_0px_3px_rgba(0,0,0,0.2)] rounded-xl', isEditHovered ? 'animate-button-text-enter' : 'animate-button-text-leave')}>Редактировать профиль</div>
      <div className={clsx('-z-[1] absolute top-[42%] right-[-75%] text-nowrap bg-white pl-8 p-2 shadow-[0px_0px_3px_rgba(0,0,0,0.2)] rounded-xl', isDeleteHovered ? 'animate-button-text-enter' : 'animate-button-text-leave')}>Удалить профиль</div>
      <div className={clsx('-z-[1] absolute top-[72%] right-[135%] text-nowrap bg-white pl-8 p-2 shadow-[0px_0px_3px_rgba(0,0,0,0.2)] rounded-xl', isLogoutHovered ? 'animate-button-text-enter' : 'animate-button-text-leave')}>Выйти</div>
    </div>
  );
};
